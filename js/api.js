// URL Backend ของคุณ (อ้างอิงจากรูปภาพล่าสุด)
...
const AppDataLayer = {
    // 1. ดึงข้อมูล 5 ปัจจัย (จำลองโครงสร้างจาก BSD API)
    ...
    async sendToGasDatabase(matchData) {
        try {
            await fetch(GAS_BACKEND_API_URL, {
                method: 'POST',
                headers: { 'Content-Type': 'text/plain' }, // ป้องกันเบราว์เซอร์บล็อก OPTIONS Preflight
